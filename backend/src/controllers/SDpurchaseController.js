...
export async function createpurchase(req, res) {
    try {
        const { apartmentNo, buyer_Name, userId, buyer_Email, buyer_Phone, room_type, price, purchase_date, content, 
        ...
        // Basic validation
        if (!apartmentNo || !buyer_Name || !userId || !buyer_Email || !buyer_Phone || !room_type || !price || !purchase_date || !content) {
...
export async function updatedpurchase(req, res) { 
    try {
        ...
        const { apartmentNo, buyer_Name, userId, buyer_Email, buyer_Phone, room_type, price, purchase_date, content } = req.body;
        ...
        const updatedPurchase = await Purchase.findByIdAndUpdate(
            req.params.id,
            { 
                apartmentNo, buyer_Name, userId, buyer_Email, buyer_Phone, 
