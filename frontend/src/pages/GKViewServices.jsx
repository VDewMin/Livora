...
import "jspdf-autotable"; // important to enable autoTable
...
function GKViewServices() {
  ...
  // Convert file buffer to base64 for display
  ...
  const handleDownloadAllProcessingPDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Services Report", 105, 15, { align: "center" });
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.setFontSize(10);
      doc.text(
        "Generated by Livora Service System",
