...
function GKViewServices() {
  ...
  return (
    <div className="max-w-7xl p-6 mt-0 bg-white rounded-2xl shadow-md font-sans-serif">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="bg-sky-500 text-white mr-0 px-4 py-2 rounded hover:bg-blue-700"
        >
          + New Service
        </button>
      </div>
                  ...
                  <tr key={s._id} className="hover:bg-gray-50">
                    ...
                    <td className="p-3 border flex flex-col gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 bg-green-500 text-white px-7 py-1 rounded hover:bg-green-600"
                      >
