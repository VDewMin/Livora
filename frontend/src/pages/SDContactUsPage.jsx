          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-teal-50 p-6 rounded-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-1 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">+94 112 345 679</p>
              </div>
            </div>
            ...
            <div className="bg-teal-50 p-6 rounded-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-1 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">info@pearlresidencies.com</p>
                <p className="text-gray-600">support@pearlresidencies.com</p>
              </div>
            </div>
