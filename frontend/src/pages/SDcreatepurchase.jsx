...
const SDcreatepurchase = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (name === 'room_type') {
            ...
            // Clear rental fields when switching away from rent
            if (value !== 'rent') {
                setFormData(prev => ({
                    ...prev,
                    lease_duration: '',
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Prepare payload - only include rental fields if room_type is rent
            const payload = {
            ...
            // Add rental-specific fields only if room_type is 'rent'
            if (formData.room_type === 'rent') {
    ...
    const roomTypeOptions = [
     ...
     //   { value: 'lease', label: 'Lease', hasDuration: true },
       // { value: 'mortgage', label: 'Mortgage', hasDuration: false }
    ];

    // Duration options (for rent)
        ...
        <div className='min-h-screen bg-base-200'>
            <div className='container mx-auto px-3 py-8'>
                <div className='max-w-4xl mx-auto'>
                    <Link to='/purchases' className='btn btn-ghost mb-6'>
                    ...
                    <div className='card bg-base-100 shadow-xl'>
                        <div className='card-body'>
                            ...
                            <form onSubmit={handleSubmit} className='space-y-6'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                    ...
                                    <div className='form-control'>
                                        ...
                                        <input
                                            ...
                                            className={`input input-bordered w-full ${errors.buyer_id ? 'input-error' : ''}`}
                                ...
                                <div className='divider'>Apartment Details</div>
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                    <div className='form-control'>
                                        <label className='label'>
                                        ...
                                        <input
                                            ...
                                            name='room_id'
                                            placeholder='APT-123'
                                            className={`input input-bordered w-full ${errors.room_id ? 'input-error' : ''}`}
                                    ...
                                    <div className='form-control'>
                                        ...
                                        <select
                                            name='room_type'
                                            className={`select select-bordered w-full ${errors.room_type ? 'select-error' : ''}`}
                                ...
                                {showDurationFields && (
                                    <>
                                        <div className='divider'>Rental Agreement Details</div>
                                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                                            <div className='form-control'>
                                                ...
                                                <select
                                                    name='lease_duration'
                                                    className={`select select-bordered w-full ${errors.lease_duration ? 'select-error' : ''}`}
                                            ...
                                            <div className='form-control'>
                                                ...
                                                <input
                                                    ...
                                                    className={`input input-bordered w-full ${errors.lease_start_date ? 'input-error' : ''}`}
                                        ...
                                        <div className='form-control mb-4'>
                                            ...
                                            <input
                                                ...
                                                className={`input input-bordered w-full ${errors.security_deposit ? 'input-error' : ''}`}
                                ...
                                <div className='divider'>Financial Information</div>
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                    <div className='form-control'>
                                        <label className='label'>
                                ...
                                <div className='card-actions justify-end gap-4'>
                                    <Link to='/purchases' className='btn btn-ghost'>
                                        Cancel
                                    </Link>
                                    <button 
                                        type='submit' 
